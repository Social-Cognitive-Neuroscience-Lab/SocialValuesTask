...
`z ~ 1 + moral`
```{r}
png('model1_preds.png', width=1600, height=1000, res = 120)
...
`a ~ 1 + moral`
```{r}
png('model2_preds.png', width=1600, height=1000, res = 120)
...
`v ~ 1 + support + moral`
```{r}
png('model3_preds.png', width=1600, height=1000, res = 120)
...
`v ~ 1 + support`
```{r}
png('model4_preds.png', width=1600, height=1000, res = 120)
...
`z ~ 1 + support + moral`
```{r}
png('model5_preds.png', width=1600, height=1000, res = 120)
