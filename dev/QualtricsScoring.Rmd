...
```{r}
require(sjPlot)
plot_model(resp_mod3, type="pred", terms=c('LeftAdjDiff')) +
  labs(x="Support (Left - Right)", y="Probability of choose") +
  theme_classic()
```
```{r}
plot_model(resp_mod3, type="pred", terms=c('LeftMoral_diff')) +
  labs(x="Moral Conviction (Left - Right)", y="Probability of choose") +
  theme_classic()
```
